...
<form id="geomap">
	...
	<div id="geoValues"></div>

	<c:choose>
		<c:when test="${not empty listLocations}">
			<div id="panel" style="margin-top: 80px">
				<label>Choose one Location: </label>
			<div id="comboLocations">
					<select id="locationId" name="locationSelected"
						style="width: 263px;">
		...
		<c:otherwise>
			<h3 style="margin-top: 100px">No locations found on our database.</h3>
		</c:otherwise>
	</c:choose>
